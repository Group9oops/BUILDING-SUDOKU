...
public class Game extends Observable {
     ...
     * 
     * @rohan help True for help on, false for help off.
     */
     ...
     *
     * @rohan selectedNumber    Number selected by user.
     */
     ...
     *
     * @rohan x     X position in game.
     * @rohan y     Y position in game.
     ...
     *
     * @rohan x         The x position in the game.
     * @rohan y         The y position in the game.
     * @rohan number    The number to be set.
     */
     ...
     *
     * @rohan game      Game to check.
     * @rohan y         Position of x axis to check.
     * @rohan number    Number to check.
     ...
     *
     * @rohan game      Game to check.
     * @rohan x         Position of y axis to check.
     * @rohan number    Number to check.
     ...
     *
     * @rohan game      Game to check.
     * @rohan x         Position of number on x axis in game to check.
     * @rohan y         Position of number on y axis in game to check.
     * @rohan number    Number to check.
     ...
     * @rohan x         X position in game.
     * @rohan y         Y position in game.
     * @rohan numbers   List of remaining numbers.
     ...
     *
     * @rohan game      Game to fill, user should pass 'new int[9][9]'.
     * @rohan index     Current index, user should pass 0.
     ...
     *
     * @rohan game      Game to be generated, user should pass a solution.
     ...
     *
     * @rohan game          Game to be generated.
     * @rohan positions     List of remaining positions to clear.
     * @return              Generated Sudoku game.
     */
     ...
     *
     * @rohan game                  Game to check.
     * @rohan index                 Current index to check.
     * @rohan numberOfSolutions     Number of found solutions. Int[] instead of
